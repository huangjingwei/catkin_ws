...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbook_arm_controller_configuration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/catkin_ws/install/${idir}'.  Ask the maintainer 'Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
