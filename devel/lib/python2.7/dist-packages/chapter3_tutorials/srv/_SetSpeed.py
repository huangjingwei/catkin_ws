...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_f.pack(self.desired_speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.desired_speed,) = _struct_f.unpack(str[start:end])
      return self
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2fB.pack(_x.previous_speed, _x.new_speed, _x.stalled))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.previous_speed, _x.new_speed, _x.stalled,) = _struct_2fB.unpack(str[start:end])
